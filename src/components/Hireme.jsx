...
const Hireme = () => {
  return (
    <section id="hireme" className="py-10 px-3 text-white">
      ...
      <div className="bg-gray-700  relative px-8 rounded-2xl py-5 lg:max-w-4xl mx-auto min-h-[24rem] mt-24 flex gap-6 lg:flex-row flex-col-reverse justify-center items-center">
        <div>
